package net.bartacus.nbamod.entities;
...
public class NBAPlayerEntity extends Animal {
    public NBAPlayerEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob mob) {
        return EntityInit.NBA_PLAYER.get().create(level);
    }
